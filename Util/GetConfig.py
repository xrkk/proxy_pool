...
class GetConfig(object):
    ...
    def fetch_interval(self):
        return int(self.config_file.get('MISC', 'fetch_interval'))

    @LazyProperty
    def refresh_interval(self):
        return int(self.config_file.get('MISC', 'refresh_interval'))

    @LazyProperty
    def refresh_process_num(self):
        return int(self.config_file.get('MISC', 'refresh_process_num'))

    @LazyProperty
    def validate_interval(self):
        return int(self.config_file.get('MISC', 'validate_interval'))

    @LazyProperty
    def max_limit(self):
        return int(self.config_file.get('MISC', 'max_limit'))

    @LazyProperty
    def is_validate_proxy(self):
        return bool(int(self.config_file.get('MISC', 'is_validate_proxy')))
